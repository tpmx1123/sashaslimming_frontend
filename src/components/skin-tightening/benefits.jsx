  ...
  return (
    <div className="w-full bg-purple-50 py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-8">
      <div className="max-w-6xl mx-auto">
        {/* Heading */}
        <motion.h2 
          className="font-montserra text-xl md:text-2xl lg:text-4xl xl:text-4xl font-bold text-[#61338A] text-center mb-3 md:mb-4 lg:mb-6 font-be-vietnam"
