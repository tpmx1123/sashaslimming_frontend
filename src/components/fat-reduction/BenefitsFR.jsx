...
const BenefitsFR = () => {
  ...
  return (
    <div className="w-full bg-[#EBE8F0] pt-2 md:pt-3 lg:pt-4 pb-12 md:pb-16 lg:pb-20 px-4 sm:px-6 md:px-8 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          {benefits.map((benefit) => (
            <motion.div
              key={benefit.id}
              className=" rounded-2xl p-4 md:p-2 flex items-center gap-4 md:gap-4 hover:shadow-md transition-shadow duration-300"
              style={{
                background: "white"
              }}
              variants={{
