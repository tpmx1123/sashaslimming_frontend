          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-4 sm:space-y-4">
              ...
              <div className="flex items-center justify-center gap-4 pt-3 sm:pt-2">
                <a href="https://www.instagram.com/sashaluxeslimming?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-white hover:text-[#D4AF37] transition-colors p-1 sm:p-0" aria-label="Instagram">
                ...
                <a href="https://www.facebook.com/sashaclinics/?ref=embed_page#" className="text-white hover:text-[#D4AF37] transition-colors p-1 sm:p-0" aria-label="Facebook">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="https://www.youtube.com/channel/UCQ-Vy5vEm_ubDiEPYQOunpw" className="text-white hover:text-[#D4AF37] transition-colors p-1 sm:p-0" aria-label="YouTube">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
