...
const faqData = [
  {
    question: 'Is muscle toning safe?',
    answer: 'Yes, muscle toning treatments are safe when performed with certified devices under professional guidance.'
  },
  {
    question: 'How soon will I see results?',
    answer: 'Clients often feel stronger and more toned after the first few sessions, with visible definition typically developing over 4 8 sessions.'
  },
  {
    question: 'Do I need to exercise during treatment?',
    answer: 'Exercise isn’t required during treatment, but staying active can help enhance and maintain your results.'
  },
  {
    question: 'Is there downtime?',
    answer: 'No, there is no downtime — you can resume your normal activities immediately after the treatment.'
  },
];
...
const FAQMB = () => {
  ...
  return (
    <div className="w-full bg-white pt-0 pb-8 md:pb-12 lg:pb-16 px-4 sm:px-6 md:px-8 lg:px-8">
      ...
      >
        <motion.h2
          className="font-montserra text-xl md:text-2xl lg:text-4xl xl:text-4xl font-bold text-[#61338A] text-center mb-6 md:mb-8 lg:mb-10"
